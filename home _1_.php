              ...
              <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box shadow">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?php echo number_format($stockAll["stock_qty"]) ?> PCS / Rp<?php echo number_format($stockAll["stock_value"]) ?></span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
          ...
          ?>
            ...
            <div class="row mb-3">
                  ...
                  <div class="card-body pt-2">
                      ...
                      <div class="col pr-2">
                        <div class="row justify-content-center">
                          <div class="text-uppercase description-block">
                            ...
                            ?>
                            <h2 style="color:<?php echo $colorRemaining ?>"><span style="font-size:25px">Rp</span><?php echo $strRemaining ?></h2>
                          </div>
                        </div>
                        <div class="text-uppercase description-block">
                          <h5>Year to Date</h5>
                          <h2 style="color:<?php echo $colorYtd ?>"><span style="font-size:25px">Rp</span><?php echo number_format($pytd["penjualan"]) ?></h2>
                        </div>
                      </div>
                    </div>
                    <div class="text-uppercase col px-2 pt-3">
                      ...
                      <div class="progress" style="height: 30px;">
                        <div class="progress-bar bg-<?php echo $typeMtd ?>" role="progressbar" style="width: <?php echo number_format((100 * $pmtd["penjualan"]) / ($target ?: 1)) ?>%" aria-valuenow="<?php echo number_format((100 * $pmtd["penjualan"]) / ($target ?: 1)) ?>%" aria-valuemin="0" aria-valuemax="100">
                          <h5 style="padding-top:5px"><?php echo number_format((100 * $pmtd["penjualan"]) / ($target ?: 1)) ?>%</h5>
                        </div>
                      </div>
                      <h5 class="text-right pt-2 pr-1"><span style="font-size:15px">Rp</span><?php echo number_format($target) ?></h5>
                    </div>
                    <div class="text-uppercase col px-2">
                      <h4>Y/D</h4>
                      <div class="progress" style="height: 30px;">
                        <div class="progress-bar bg-<?php echo $typeYtd ?>" role="progressbar" style="width: <?php echo number_format((100 * $pytd["penjualan"]) / ($targetYtd ?: 1)) ?>%" aria-valuenow="<?php echo number_format((100 * $pytd["penjualan"]) / ($targetYtd ?: 1)) ?>%" aria-valuemin="0" aria-valuemax="100">
                          <h5 style="padding-top:5px"><?php echo number_format((100 * $pytd["penjualan"]) / ($targetYtd ?: 1)) ?>%</h5>
                        </div>
                      </div>
                      <h5 class="text-right pt-2 pr-1"><span style="font-size:15px">Rp</span><?php echo number_format($targetYtd) ?></h5>
                      </h5>
                    </div>
              ...
              <div class="col-sm-4 col-12">
                <div class="card h-100 card-warning">
                  <div class="card-header">
                    <h3 class=" text-uppercase card-title"><?php echo $datatoko["nama"]; ?> - Stock Sold</h3>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="text-uppercase row mt-4">
                      <h6><b>TOTAL KAIN TERJUAL : <?php echo number_format($totalQtySold) ?> PCS</b></h6>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-4 col-12">
                <div class="card h-100 card-warning">
                  <div class="card-header">
                    <h3 class=" text-uppercase card-title"><?php echo $datatoko["nama"]; ?> - Stock Available</h3>
                  </div>
                  <div class="card-body">
                        ...
                        ?>
                          <tr>
                            ...
                            ?>
                              <td class="text-uppercase"><?php echo $data["kode_jenis_kain"]; ?></td>
                              <td><?php echo number_format($data["qty"]); ?></td>
                              <td>Rp<?php echo number_format($data["sum_harga_beli"]); ?></td>
                            <?php
                            } else {
                            ?>
                              <td><?php echo $counter; ?></td>
                              <td><?php echo $data["kode_jenis_kain"]; ?></td>
                              <td><?php echo number_format($data["qty"]); ?></td>
                            <?php
                            }
                            ?>
                    ...
                    <div class="text-uppercase row mt-4">
                      <h6><b>TOTAL KAIN AVAILABLE : <?php echo number_format($totalQtyAvailable) ?> PCS</b></h6>
                    </div>
                    <?php
                    if ($_SESSION["role"] == "admin") {
                    ?>
                      <div class="text-uppercase row mt-1">
                        <h6><b>TOTAL KAIN AVAILABLE : Rp<?php echo number_format($totalHargaAvailable) ?></b></h6>
                      </div>
                    <?php
                    }
                    ?>
