    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Monitoring - Stock All</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      ?>
                        <div class="row mt-1">
                          <div class="col-12 col-sm-3">
                            <a type="button" href="monitoring_stock_all.php?go=1" class="filter-button btn btn-block btn-warning"><b>GO</b></a>
                          </div>
                        </div>
                        <div class="row mt-1">
                          <div class="col-12 col-sm-3">
                            <span>* Will load all stock data. Please be patient loading process will take for a while</span>
                          </div>
                        </div>
                      <?php
                      }
