    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Atara Privilege - Member</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/home.php">Home</a></li>
                <li class="breadcrumb-item active"><a href="/privilege_member.php">Atara Privilege</a></li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                      ...
                                      <div class="modal-body">
                                        <div class="row px-2 mt-1">
                                          <div class="col-12 col-sm-8">
                                            <form class="form-inline" action="privilege_member.php" method="get">
